...
import com.example.java_android_app.databinding.ActivityProgressbarinfoBinding;


public class Progressbarinfo extends AppCompatActivity {

    private ActivityProgressbarinfoBinding binding ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        binding = ActivityProgressbarinfoBinding.inflate(getLayoutInflater());
